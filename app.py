...
.hero p { color: rgb(148,163,184); margin: 0.3rem 0 0 0; }
.plate-box { background: rgb(15,23,42); border: 2px solid rgb(124,58,237); border-radius: 12px; padding: 1.5rem; text-align: center; margin-bottom: 1rem; }
.plate-text { font-size: 2rem; font-weight: 700; letter-spacing: 0.15em; color: rgb(241,245,249); background: rgb(30,41,59); border: 1px solid rgb(51,65,85); border-radius: 8px; padding: 0.4rem 1.2rem; display: inline-block; margin: 0.5rem 0; font-family: monospace; }
.badge-ok { display: inline-block; background: rgb(6,78,59); color: rgb(52,211,153); font-size: 0.82rem; padding: 0.2rem 0.8rem; border-radius: 99px; }
.badge-low { display: inline-block; background: rgb(69,26,3); color: rgb(251,146,60); font-size: 0.82rem; padding: 0.2rem 0.8rem; border-radius: 99px; }
.metrics { display: flex; gap: 0.8rem; margin: 1rem 0; flex-wrap: wrap; }
.met { flex: 1; min-width: 100px; background: rgb(15,15,26); border: 1px solid rgb(30,32,53); border-radius: 10px; padding: 0.8rem; text-align: center; }
.met-val { font-size: 1.3rem; font-weight: 700; color: rgb(167,139,250); font-family: monospace; }
.met-lbl { font-size: 0.7rem; color: rgb(100,116,139); }
.hist-item { background: rgb(13,13,24); border: 1px solid rgb(26,26,46); border-radius: 6px; padding: 0.5rem 0.8rem; margin-bottom: 0.4rem; font-family: monospace; font-size: 0.85rem; display: flex; justify-content: space-between; }
